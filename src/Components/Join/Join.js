  ...
  return (
    ...
    <div className='flex flex-col md:flex-row w-full '>
        ...
        <div className='w-full'>
            ...
            <p className=' font-medium text-center px-8 mb-10 text-white md:text-left'>Thank you for showing interest in the Nerdy Eye’s Recruitment program. Please fill the form below and we will connect you with your ideal employers as soon as possible.</p>
            <div className='flex flex-col w-full px-10'>
                <div className='w-full flex flex-col gap-4 font-Montserrat-Bold mb-8 '>
                    <p className='text-[#575757] flex gap-2'>Role <span className='text-[#D23431]'>*</span> </p><input type='text' className='bg-[#222222] rounded-md text-white py-5 md:w-4/5'/>
                </div>
                <div className='w-full flex flex-col gap-4 font-Montserrat-Bold mb-8'>
                    <p className='text-[#575757] flex gap-2'>Year of Experience <span className='text-[#D23431]'>*</span> </p><input type='text' className='bg-[#222222] rounded-md text-white py-5 w-full md:w-4/5' />
                </div>
                <div className='w-full flex flex-col gap-4 font-Montserrat-Bold mb-8'>
                    <p className='text-[#575757] font-Montserrat-Bold flex gap-2'>Work type<span className='text-[#D23431]'>*</span> </p><input type='text' className='bg-[#222222] rounded-md text-white py-5 w-full md:w-4/5' />
                </div>
