...
const JobOffers = () => {
  ...
  return (
    <div className=" md:px-20 py-10" ref={contref}>
      ...
      <div className="text-white font-Montserrat-Bold text-center mb-20 sm:text-xl lg:text-[32px]">
        JOB OFFERS
      </div>
          ...
          <div className="flex justify-center lg:justify-start h-fit  ">
            <div className="flex flex-col border-r border-white border-solid pr-5 items-center">
              <div className="flex font-Montserrat-Bold text-3xl md:text-5xl text-white">
                500<span className="text-[#D23432]">+</span>
              </div>
              <div className="text-white font-Montserrat-Medium">
                Job Offers
              </div>
            </div>
            ...
            <div className="pl-5 items-center">
              <div className="flex font-Montserrat-Bold text-3xl md:text-5xl text-white">
                100<span className="text-[#D23432]">+</span>
              </div>
      ...
      <div className="flex flex-col mx-auto p-10 w-full relative lg:-mt-72 xl:-mt-96 max-w-lg lg:max-w-7xl">
      ...
      <div className="w-full flex justify-center lg:hidden">
        <button className="px-6 py-3 border-solid border-[#D23432] text-[#D23432] border-2 rounded-lg mx-auto font-Montserrat-Bold">
          See More
        </button>
      </div>
      <img
